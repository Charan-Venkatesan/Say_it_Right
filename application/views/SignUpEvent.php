...
<body>
	...
	<div id = "wrapper">
		...
		<!--<?php include 'PHP/signupeventvalidation.php'?>-->
		<div class = "signup">
			<form method = "POST" align = "center" onsubmit = "return validateSignupEve();" name = "signeveform" action = "<?php echo htmlspecialchars($_SERVER["PHP_SELF"])?>">
				<fieldset>
					...
					<hr>
					<p class = "welcome"> Welcome to the event log </p>
					<font color = "red" size =1.5px><?php echo form_error('name');?></font><br>
					<input type = "text" placeholder="Enter your name" size ="100" name = "name" value = "<?php echo set_value('name');?>" ><font color = "red" size = 1.5px>*</font><br>
					...
					<button class = "send-button" type = "submit" name = "submit">SEND</button>
				</fieldset>
			</form>
