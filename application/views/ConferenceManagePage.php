		...
		<div class ="header">
			<div id ="nav">
				<ul>
					...
					<li><a class = "flash" href = "<?php echo base_url();?>index.php/Home/conferenceManagePage">Conferences</a></li>
			...
			<table align ="center">
				...
				<?php 
                    foreach($conferences as $co){
                        echo "<tr><td>".$co->ConfName."</td><td>".$co->ConfDesc."</td><td>".$co->Date."</td><td>".$co->Location."</td><tr>";
                    }
                    echo "</table></center>";
                ?>
			</table>
