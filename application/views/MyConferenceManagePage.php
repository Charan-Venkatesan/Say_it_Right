...
<body>
	...
	<div id = "wrapper">
		<div class ="header">
			<div id ="nav">
				<ul>
					...
					<li><a class = "flash" href = "<?php echo base_url();?>index.php/Home/myConferenceManagePage">My Conferences</a></li>
		...
		<div class = "conftable">
			<h4 class ="buy">List of My Conferences </h4>
			...
			<table align ="center">
				...
				<?php 
				    foreach($myconference as $mc){
                        echo "<tr><td>".$mc->ConfName."</td><td>".$mc->ConfDesc."</td><td>".$mc->Date."</td><td>".$mc->Location."</td></tr>";
                        }
                    echo "</table></center>";
                ?>
			</table>
