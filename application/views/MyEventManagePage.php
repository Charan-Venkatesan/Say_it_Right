		...
		<div class ="header">
			<div id ="nav">
				<ul>
					...
					<li><a class = "flash" href = "<?php echo base_url();?>index.php/Home/myEventManagePage">My Events</a></li>
			...
			<table align ="center">
				...
				<?php 
                    foreach($myevents as $me){
                        echo "<tr><td>".$me->EventName."</td><td>".$me->Description."</td><td>".$me->Date."</td><td>".$me->Location."</td><tr>";
                    }
                    echo "</table></center>";
                ?>
			</table>
