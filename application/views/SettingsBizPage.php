		...
		<div class ="settings">
			<form method = "POST" align = "center" action = "<?php echo htmlspecialchars($_SERVER["PHP_SELF"])?>" enctype="multipart/form-data">
				...
				<fieldset>
					...
					<hr>
					<img class = "profpic" src = "<?php echo base_url();?>/resources/Uploads/<?=$u->ProfilePic?>" alt = "defaultprofilepic">
					<div class = "lists">
					    <label class = "radio"> type of business
					    <input class = "radio" name = "biz" type = "radio" value ="University"> <p class = "radio"> University</p>
					    <input class = "radio" name = "biz" type = "radio" value = "Company" ><p class ="radio"> Company </p></label><br>
						<input type = "text" placeholder="Enter last name" size ="60" name = "lname" value = "<?php echo $u->lastname;?>">
						...
						<input type = "text" placeholder="Enter password" size = "60" name = "pwd" value = "<?php echo $u->password;?>"><br>
