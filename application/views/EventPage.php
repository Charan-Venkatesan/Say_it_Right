		...
		<div class ="header">
			<div id ="nav">
				<ul>
					...
					<li><a class = "flash" href = "<?php echo base_url();?>index.php/Home/eventPage">Events</a></li>
			...
			<table align ="center">
				...
				<?php 
                    foreach($events as $ev){
                        echo "<tr><td>".$ev->EventName."</td><td>".$ev->Description."</td><td>".$ev->Date."</td><td>".$ev->Location."</td><td><button>Confirm</button></td><tr>";
                        }
                    echo "</table></center>";
                ?>
			</table>
