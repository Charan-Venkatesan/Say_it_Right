	...
	<div id = "wrapper">
		<div class ="header">
			<div id ="nav">
				<ul>
					...
					<li><a class ="flash" href = "<?php echo base_url();?>index.php/Home/loginBizPage">Home</a></li>
					<li><a href = "<?php echo base_url();?>index.php/Home/conferenceManagePage">Conferences</a></li>
					<li><a href = "<?php echo base_url();?>index.php/Home/eventBizPage">Events</a></li>
		...
		<div>
			...
			<form method = "POST" align = "center" action = "<?php echo htmlspecialchars($_SERVER["PHP_SELF"])?>">
				<fieldset>
					<p> Welcome to your Business Account</p>	
					<hr>
					<div class = "lists">
						<input type = "text" placeholder="Enter Conference Title" size ="60" name = "title" value = "<?php echo set_value('title');?>">
						<font color = "red" size = "1.5px">*<?php echo form_error('title');?></font>
						<input type = "text" placeholder="Enter Conference Description" size = "60" name = "desc"  value = "<?php echo set_value('desc');?>">
						<font color = "red" size = "1.5px">*<?php echo form_error('desc');?></font>
						<input type = "text" placeholder="Enter Conference Date(YYYY-MM-DD)" size = "60" name = "date" value = "<?php echo set_value('date');?>">
						<font color = "red" size = "1.5px">*<?php echo form_error('date');?></font>
						<input type = "text" placeholder="Enter Conference Location" size = "60" name = "loc" value = "<?php echo set_value('loc');?>">
						<font color = "red" size = "1.5px">*<?php echo form_error('loc');?></font><br>
						<button type = "submit" name ="add"> ADD CONFERENCE</button>
						<button type ="submit" name = "delete"> DELETE CONFERENCE</button>
						<p></p>
