		...
		<div class ="header">
			<div id ="nav">
				<ul>
					...
					<li><a class = "flash" href = "<?php echo base_url();?>index.php/Home/myConferenceEventPage">My Conferences</a></li>
			...
			<table align ="center">
				...
				<?php 
				    foreach($myconference as $mc){
                        echo "<tr><td>".$mc->Conferences."</td><td>".$mc->Description."</td><td>".$mc->Date."</td><td>".$mc->Location."</td><td>Confirmed</td><tr>";
                        }
                    echo "</table></center>";
                ?>
			</table>
